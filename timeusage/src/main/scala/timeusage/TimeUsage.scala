...
object TimeUsage extends TimeUsageInterface{
  ...
  def timeUsageSummaryTyped(timeUsageSummaryDf: DataFrame): Dataset[TimeUsageRow] = {
    timeUsageSummaryDf.map(rows =>
      TimeUsageRow(rows.getAs[String](0),rows.getAs[String](1),rows.getAs[String](3),rows.getAs[Double](4),rows.getAs[Double](5),rows.getAs[Double](6))
    )
  }
